      ...
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-col text-center w-full mb-20">
            <h2 className="text-xs text-blue-500 tracking-widest font-medium title-font mb-1">PTI EXCHANGE CURRENCY</h2>
          ...
          <button className="flex mx-auto bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium mt-16 text-white  border-0 py-4 px-8 focus:outline-none hover:bg-blue-600 rounded-2xl ">Button</button>
        </div>
      </section>
    </>
  );
